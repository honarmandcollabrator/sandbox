...
class ResetPasswordController extends Controller
{
    ...
    */
     ...
     * @return array|\Illuminate\Contracts\Routing\ResponseFactory|\Illuminate\Http\JsonResponse|\Illuminate\Http\Response
     */
...
//                    return $this->sendError(trans('passwords.user'), 404);
                    return response(trans('passwords.user'), Response::HTTP_NOT_FOUND);
                case static::INVALID_PASSWORD:
//                    return $this->sendError(trans('passwords.password'), 422);
                    return response(trans('passwords.password'), Response::HTTP_UNPROCESSABLE_ENTITY);
                case static::INVALID_TOKEN:
//                    return $this->sendError(trans('passwords.token'), 422);
                    return response(trans('passwords.token'), Response::HTTP_EXPECTATION_FAILED);
            }
        }
